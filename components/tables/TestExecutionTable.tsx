...
import { Edit, Trash2, History, Search, Filter, RefreshCw, TestTube2, Calendar, User, Target, TrendingUp } from 'lucide-react';
  ...
  if (error) {
    return (
      <Card className="glass-effect">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            <TestTube2 className="h-6 w-6 text-red-600" />
            <span>Test Executions</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center justify-center py-16">
            <div className="bg-red-50 border border-red-200 rounded-xl p-8 max-w-md text-center">
              <TestTube2 className="h-12 w-12 text-red-600 mx-auto mb-4" />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Badge variant="outline" className="text-sm">
              {testExecutions.length} executions
            </Badge>
          </div>
        </div>
      </CardHeader>
        ...
        {uniqueTasksArray.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-12 max-w-lg text-center">
              <TestTube2 className="h-16 w-16 text-blue-400 mx-auto mb-6" />
              ...
              <p className="text-blue-600 mb-6 leading-relaxed">
                {filters.search || filters.status !== 'all' 
                  ...
                  : 'Create your first test execution to get started with QA monitoring!'
                }
              </p>
              {(filters.search || filters.status !== 'all') && (
                <Button
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gradient-to-r from-gray-50 to-blue-50 border-b-2 border-gray-200">
                  ...
                  <TableHead className="font-bold text-gray-800 text-center">Executions</TableHead>
                  <TableHead className="font-bold text-gray-800">
                    <div className="flex items-center space-x-2">
                  ...
                  <TableRow key={execution._id} className="hover:bg-blue-50/50 transition-colors border-b border-gray-100">
                    ...
                    <TableCell>
                      <div className="text-center">
                        <div className={`font-bold text-lg px-2 py-1 rounded ${getPassRateColor(execution.passedTestCases, execution.totalTestCases)}`}>
