...
export async function PUT(
  ...
  try {
    ...
    const { tags, description, testCases } = body;
    ...
    return NextResponse.json({
      success: true,
      data: updatedTask,
      message: 'Unit test case updated successfully',
    });
  } catch (error) {
    ...
    return NextResponse.json(
      {
        success: false,
        error: 'Failed to update unit test case',
      },
      { status: 500 }
    );
  }
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Unit test case deleted successfully',
    });
  } catch (error) {
    ...
    return NextResponse.json(
      {
        success: false,
        error: 'Failed to delete unit test case',
      },
      { status: 500 }
    );
  }
